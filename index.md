...
<link rel="icon" type="image/png" href="/favicon-new.png">
    ...
    <title>Dorsa Jabaroti Moghadam's Resume </title>
<meta name="description" content="Im a computer engineering student and English teacher">
...
<script>
    $(function () {
        ...
        <div class="row" style="height:100%">
            <div class="smbox col-narrow sortable-cv-items">
                ...
                <h1 class="not-drag">Dorsa Jabaroti Moghadam</h1>
                    <h2 class="job-title not-drag">English teacher</h2>
    ...
    <div class="property-item basic__about" data-section="About">
        ...
        <div class="property-item_body">
            <p class="about-us">
                Im a computer engineering student and English teacher
            </p>
        </div>
    </div>
            ...
            <ul class="history multi-line">
                    <li>
                        ...
                        <h3 class="subtitle"></h3>
                                    <h3 class="subtitle">Institute/University: karaj pnu </h3>
                                                    <label class="date">From  1397</label>
                                                    <label class="Education-Grade">GPA : 15</label>
                    </li>
                    <li>
                        <h2 class="subtitle">Diploma of mathematics</h2>
                        <h3 class="subtitle"></h3>
                                    <h3 class="subtitle">Institute/School: albprz </h3>
                                                    <label class="date"> 1393 -  1397</label>
                                                    <label class="Education-Grade">GPA : 19</label>
                    </li>
            </ul>
        </div>
    </div>
            ...
            <ul class="history multi-line">
                        <li class="866792">
                            ...
                            <h3 class="subtitle">
                                ...
                                <label class="date">From July 1396</label>

                        </li>
                        <li class="866793">
                            <h2 class="subtitle"> internal management</h2>
                            <h3 class="subtitle">

                            </h3>
                                <label class="date">August 1398 - December 1398</label>
        ...
        <div class="property-item_body">
            <ul class="history one-line">
                    <li>
                        ...
                        <h3 class="subtitle">Institute: University Jihad</h3>
                            <label class="date"><label class="text-date">Date:</label> July 1397</label>
                    </li>
                    <li>
                        <h2 class="subtitle bidirectional">ielts</h2>
                        <h3 class="subtitle">Institute: kish wek</h3>
                            <label class="date"><label class="text-date">Date:</label> August 1395</label>
                    </li>
            </ul>
        </div>
    </div>
...
<a href="https://dorsajabarooti.github.io/">FA</a>
